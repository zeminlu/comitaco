 ...
 */
  ...
  final public VariableDeclarator VariableDeclarator(Environment env) throws ParseException {
    ...
    default:
      ...
      ;
        ...
        VariableDeclarator res =  new VariableDeclarator( p1, p2, p3 );
        {if (true) return res;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Parameter FormalParameter(Environment env) throws ParseException {
    ...
    p4 = EmptyBracketsOpt();
        ...
        Parameter res = new Parameter( p1, p2, p3 );
 ...
 */
  ...
  final public AssignmentExpression AssignmentExpression(Environment env) throws ParseException {
    ...
    String                      p2;
    Expression                  p3;
        AssignmentExpression aexp;
    DebugOut.println( "#AssignmentExpression()" );
    p1 = PrimaryExpression(env);
    p2 = AssignmentOperator();
    p3 = Expression(env);
        aexp = new AssignmentExpression( p1, p2, p3 );
        {if (true) return aexp;}
    throw new Error("Missing return statement in function");
  }
 ...
 */
      ...
      if (LocalVariableDeclarationLookahead( env )) {
        ...
        if (mut!=null) {
                for (int i=0; i<p2.size(); i++) {
                        VariableDeclaration v = (VariableDeclaration) p2.get(i);
                        v.setComment("//mutGenLimit "+mut.toString());
                }
        }
        {if (true) return p2;}
      } else if (jj_2_42(1)) {
  ...
  final public ExpressionStatement ExpressionStatement(Environment env) throws ParseException {
    ...
    default:
      ...
      ;
        ...
        ExpressionStatement res = new ExpressionStatement(p1);
        if (p2 != null) {
                res.setComment("//mutGenLimit "+p2.toString());
        }
        {if (true) return res;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public IfStatement IfStatement(Environment env) throws ParseException {
    ...
    if (jj_2_50(2)) {
      ...
      ;
        ...
        IfStatement res = new IfStatement( p1, true_part, false_part );
        if (mut != null) {
                res.setComment("//mutGenLimit "+mut.toString());
        }
        {if (true) return res;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public WhileStatement WhileStatement(Environment env) throws ParseException {
    ...
    default:
      ...
      if (jj_2_55(1)) {
        ...
        whilestm = new WhileStatement( p1, body );
        if (mut!=null) {
                whilestm.setComment("//mutGenLimit "+mut.toString());
        }
        {if (true) return whilestm;}
    throw new Error("Missing return statement in function");
  }
  ...
  final public DoWhileStatement DoWhileStatement(Environment env) throws ParseException {
    ...
    default:
      ...
      ;
            ...
            DoWhileStatement res = new DoWhileStatement( body, p3 );
            if (mut!=null) {
                res.setComment("//mutGenLimit "+mut.toString());
            }
            {if (true) return res;}
  ...
  final public ForStatement ForStatement(Environment env) throws ParseException {
    ...
    default:
      ...
      ;
        ...
        if (mut!=null) result.setComment("//mutGenLimit "+mut.toString());
      {if (true) return result;}
    throw new Error("Missing return statement in function");
  }
    ...
    default:
      ...
      ;
        ...
        if (p1 != null) {
            ...
            if (mut!=null) {
                result.setComment("//mutGenLimit "+mut.toString());
            }
        } else {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20002000,0x8000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20002000,0x0,0x82094000,0x82094000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x10000000,0x0,0x0,0x0,0x0,0x82094000,0x1408000,0x0,0x100000,0x0,0x10000000,0x0,0x0,0x820000,0x0,0x0,0x4000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x1000,0x10,0x10,0x0,0x0,0x80000000,0x0,0x0,0x80000000,0x0,0x2224e200,0x0,0x8,0x0,0x0,0x0,0x80000000,0x1000000,0x0,0x0,0x0,0x0,0x0,0x2224e200,0x40000,0x90020140,0x10020140,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x84480c00,0x0,0x0,0x0,0x80000000,0x0,0x4000800,0x80400,0x80000000,0x4000800,0x0,0x0,0x0,0x400,0x90020140,0x48b10005,0x0,0x0,0x0,0x4000800,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x100000,0x0,0x0,0x0,0x400000,0x100000,0x800,0x200000,0x20100000,0x0,0x1,0x0,0x0,0x0,0x100000,0x100000,0x200000,0x800,0x0,0x110000,0x800000,0x10000,0x200000,0x200000,0x0,0x0,0x800,0x0,0x200000,0x200000,0x800,0x800000,0x800000,0x10000000,0x0,0x0,0x0,0x0,0x0,0x40000000,0x40000000,0x0,0x83000000,0x83000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc000000,0xc000000,0xc004ec6,0x4000,0x0,0x0,0x800,0x444000,0x6c6,0x4000,0x800,0x6c6,0x200000,0x10000,0x4000,0x0,0x800,0x110000,0x0,0x0,0x200000,0x6c6,0x0,0x0,0x0,0x10000,0x10000,0x0,0x10000,0x10000,0x0,0x10000,0x0,0x200000,0x200000,0x800,0x800,0x0,0x0,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffe0000,0xffe0000,0x0,0x4,0x8,0x800,0x1000,0x400,0x2,0x2,0x0,0x1,0x1,0x1c000,0x1c000,0xc0,0xc0,0x2300,0x2300,0xc0,0x30,0x0,0x0,0x0,0x0,0x30,0x30,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x0,0x0,0x10000000,0x30,0x0,0x0,0x0,0x0,0x0,0x0,0x10000000,0x0,0x10000000,0x0,0x0,0x0,0x0,0x10000000,0x0,};
   }
