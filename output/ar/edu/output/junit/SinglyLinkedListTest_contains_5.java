...
public class SinglyLinkedListTest_contains_5 {
    ...
    public void testcontains_0(String fileClasspath, String className, String methodName) throws IllegalAccessException, InvocationTargetException, ClassNotFoundException, InstantiationException, MalformedURLException {
        ...
        updateValue(_SinglyLinkedListNode_3, "value", _SinglyLinkedListNode_4);
        updateValue(_SinglyLinkedListNode_2, "next", _SinglyLinkedListNode_3);
        updateValue(_SinglyLinkedListNode_2, "value", _SinglyLinkedListNode_5);
