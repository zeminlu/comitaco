...
public class SinglyLinkedListTest_contains_0 {
    ...
    public void testcontains_0() {
        ...
        // Fields Initialization for '_SinglyLinkedListNode_6'
        // Fields Initialization for '_SinglyLinkedListNode_7'
        updateValue(_SinglyLinkedListNode_7, "next", null);
        updateValue(_SinglyLinkedListNode_7, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_6, "next", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_6, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_5, "next", _SinglyLinkedListNode_6);
        updateValue(_SinglyLinkedListNode_5, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_4, "next", _SinglyLinkedListNode_5);
        updateValue(_SinglyLinkedListNode_4, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_3, "next", _SinglyLinkedListNode_4);
        updateValue(_SinglyLinkedListNode_3, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_2, "next", _SinglyLinkedListNode_3);
        updateValue(_SinglyLinkedListNode_2, "value", _SinglyLinkedListNode_7);
        updateValue(_SinglyLinkedListNode_1, "next", _SinglyLinkedListNode_2);
        updateValue(_SinglyLinkedListNode_1, "value", _SinglyLinkedListNode_7);
