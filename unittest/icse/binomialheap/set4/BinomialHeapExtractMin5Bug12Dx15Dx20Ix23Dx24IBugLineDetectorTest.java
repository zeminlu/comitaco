...
public class BinomialHeapExtractMin5Bug12Dx15Dx20Ix23Dx24IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set4/BinomialHeapExtractMin5Bug12Dx15Dx20Ix23Dx24IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
