...
public class BinomialHeapExtractMin3Bug13Dx15Ix21DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set4/BinomialHeapExtractMin3Bug13Dx15Ix21DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
