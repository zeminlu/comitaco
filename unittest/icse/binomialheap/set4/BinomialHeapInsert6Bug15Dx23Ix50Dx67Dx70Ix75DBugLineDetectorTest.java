...
public class BinomialHeapInsert6Bug15Dx23Ix50Dx67Dx70Ix75DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set4/BinomialHeapInsert6Bug15Dx23Ix50Dx67Dx70Ix75DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
