...
public class BinomialHeapExtractMin6Bug8Dx12Dx15Dx23Dx27Dx38DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set4/BinomialHeapExtractMin6Bug8Dx12Dx15Dx23Dx27Dx38DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
