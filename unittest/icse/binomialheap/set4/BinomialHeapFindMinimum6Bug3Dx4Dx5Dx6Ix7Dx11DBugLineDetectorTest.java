...
public class BinomialHeapFindMinimum6Bug3Dx4Dx5Dx6Ix7Dx11DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set4/BinomialHeapFindMinimum6Bug3Dx4Dx5Dx6Ix7Dx11DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
