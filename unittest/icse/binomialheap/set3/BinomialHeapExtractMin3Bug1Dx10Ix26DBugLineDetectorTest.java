...
public class BinomialHeapExtractMin3Bug1Dx10Ix26DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapExtractMin3Bug1Dx10Ix26DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
