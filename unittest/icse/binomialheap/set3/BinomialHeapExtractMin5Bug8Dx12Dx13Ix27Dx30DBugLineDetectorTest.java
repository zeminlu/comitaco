...
public class BinomialHeapExtractMin5Bug8Dx12Dx13Ix27Dx30DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapExtractMin5Bug8Dx12Dx13Ix27Dx30DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
