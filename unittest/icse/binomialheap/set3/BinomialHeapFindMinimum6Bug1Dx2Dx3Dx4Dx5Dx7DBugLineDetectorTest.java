...
public class BinomialHeapFindMinimum6Bug1Dx2Dx3Dx4Dx5Dx7DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapFindMinimum6Bug1Dx2Dx3Dx4Dx5Dx7DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
