...
public class BinomialHeapInsert6Bug3Dx13Ix19Dx26Ix50Dx58IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapInsert6Bug3Dx13Ix19Dx26Ix50Dx58IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
