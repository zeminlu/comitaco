...
public class BinomialHeapFindMinimum3Bug2Dx3Dx6IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapFindMinimum3Bug2Dx3Dx6IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
