...
public class BinomialHeapExtractMin6Bug9Dx10Dx18Dx20Dx21Dx26DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set3/BinomialHeapExtractMin6Bug9Dx10Dx18Dx20Dx21Dx26DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
