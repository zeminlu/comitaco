...
public class BinomialHeapFindMinimum6Bug2Dx5Dx6Dx7Dx9Dx11DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set2/BinomialHeapFindMinimum6Bug2Dx5Dx6Dx7Dx9Dx11DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
