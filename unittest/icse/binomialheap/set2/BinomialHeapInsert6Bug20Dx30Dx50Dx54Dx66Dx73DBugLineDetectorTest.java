...
public class BinomialHeapInsert6Bug20Dx30Dx50Dx54Dx66Dx73DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set2/BinomialHeapInsert6Bug20Dx30Dx50Dx54Dx66Dx73DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
