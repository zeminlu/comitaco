...
public class BinomialHeapFindMinimum4Bug2Dx5Dx7Dx9DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set2/BinomialHeapFindMinimum4Bug2Dx5Dx7Dx9DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
