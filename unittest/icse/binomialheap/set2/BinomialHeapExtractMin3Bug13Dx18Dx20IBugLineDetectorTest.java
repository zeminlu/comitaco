...
public class BinomialHeapExtractMin3Bug13Dx18Dx20IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set2/BinomialHeapExtractMin3Bug13Dx18Dx20IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
