...
public class BinomialHeapFindMinimum2Bug9Dx11DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set2/BinomialHeapFindMinimum2Bug9Dx11DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
