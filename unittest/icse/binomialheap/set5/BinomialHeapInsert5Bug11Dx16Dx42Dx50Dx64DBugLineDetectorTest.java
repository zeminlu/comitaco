...
public class BinomialHeapInsert5Bug11Dx16Dx42Dx50Dx64DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set5/BinomialHeapInsert5Bug11Dx16Dx42Dx50Dx64DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
