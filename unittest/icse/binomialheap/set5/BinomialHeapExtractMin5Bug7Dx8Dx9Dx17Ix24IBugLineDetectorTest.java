...
public class BinomialHeapExtractMin5Bug7Dx8Dx9Dx17Ix24IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set5/BinomialHeapExtractMin5Bug7Dx8Dx9Dx17Ix24IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
