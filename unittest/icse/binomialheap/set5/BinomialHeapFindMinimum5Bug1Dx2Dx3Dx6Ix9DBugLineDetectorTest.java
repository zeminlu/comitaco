...
public class BinomialHeapFindMinimum5Bug1Dx2Dx3Dx6Ix9DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set5/BinomialHeapFindMinimum5Bug1Dx2Dx3Dx6Ix9DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
