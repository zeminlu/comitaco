...
public class BinomialHeapExtractMin6Bug9Dx10Ix12Dx18Dx21Dx30DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set5/BinomialHeapExtractMin6Bug9Dx10Ix12Dx18Dx21Dx30DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
