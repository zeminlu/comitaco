...
public class BinomialHeapInsert6Bug11Dx42Dx47Dx54Dx56Ix62IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set5/BinomialHeapInsert6Bug11Dx42Dx47Dx54Dx56Ix62IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
