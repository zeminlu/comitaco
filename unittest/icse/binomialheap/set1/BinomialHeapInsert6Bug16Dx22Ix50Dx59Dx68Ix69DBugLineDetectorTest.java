...
public class BinomialHeapInsert6Bug16Dx22Ix50Dx59Dx68Ix69DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set1/BinomialHeapInsert6Bug16Dx22Ix50Dx59Dx68Ix69DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
