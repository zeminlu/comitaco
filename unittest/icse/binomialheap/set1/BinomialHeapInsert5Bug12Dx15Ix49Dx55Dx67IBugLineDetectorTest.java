...
public class BinomialHeapInsert5Bug12Dx15Ix49Dx55Dx67IBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set1/BinomialHeapInsert5Bug12Dx15Ix49Dx55Dx67IBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
