...
public class BinomialHeapExtractMin5Bug10Dx13Dx21Ix26Dx38DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set1/BinomialHeapExtractMin5Bug10Dx13Dx21Ix26Dx38DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
