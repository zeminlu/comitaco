...
public class BinomialHeapExtractMin6Bug8Dx10Dx15Ix17Dx18Dx21DBugLineDetectorTest extends CollectionTestBase {
	...
	protected void setUp() {
		...
		try {
		  properties.load(new FileInputStream(System.getProperty("user.dir") + "/unittest/icse/binomialheap/set1/BinomialHeapExtractMin6Bug8Dx10Dx15Ix17Dx18Dx21DBugLineDetector.properties"));
		} catch (IOException e) {
		  e.printStackTrace();
		  return;
		}
