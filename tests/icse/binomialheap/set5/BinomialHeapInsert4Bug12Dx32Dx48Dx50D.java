...
public class BinomialHeapInsert4Bug12Dx32Dx48Dx50D {
    ...
    public BinomialHeapInsert4Bug12Dx32Dx48Dx50D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        icse.binomialheap.BinomialHeapNode tmp = temp2.findMinNode(); //mutGenLimit 1
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            temp2 = temp2.sibling; //mutGenLimit 0
                            temp1.sibling = null; //mutGenLimit 1
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = temp.sibling; //mutGenLimit 1
                //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != prevTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
