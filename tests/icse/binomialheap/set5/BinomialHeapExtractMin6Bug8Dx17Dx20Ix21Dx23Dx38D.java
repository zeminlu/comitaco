...
public class BinomialHeapExtractMin6Bug8Dx17Dx20Ix21Dx23Dx38D {
    ...
    public BinomialHeapExtractMin6Bug8Dx17Dx20Ix21Dx23Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (this.Nodes.key != minNode.key) { //mutGenLimit 1
            prevTemp = temp; //mutGenLimit 0
        ...
        while (temp != null) { //mutGenLimit 0
            temp = null; //mutGenLimit 1
            temp = temp.findMinNode().sibling; //mutGenLimit 1
        }
