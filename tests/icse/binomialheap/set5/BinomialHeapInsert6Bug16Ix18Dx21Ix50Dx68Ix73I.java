...
public class BinomialHeapInsert6Bug16Ix18Dx21Ix50Dx68Ix73I {
    ...
    public BinomialHeapInsert6Bug16Ix18Dx21Ix50Dx68Ix73I() {
    }
        ...
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || prevTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            nextTemp.parent.child = temp; //mutGenLimit 1
