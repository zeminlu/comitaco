...
public class BinomialHeapExtractMin3Bug4Dx13Ix15I {
    ...
    public BinomialHeapExtractMin3Bug4Dx13Ix15I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        icse.binomialheap.BinomialHeapNode temp = this.extractMin(); //mutGenLimit 1
        icse.binomialheap.BinomialHeapNode prevTemp = null; //mutGenLimit 0
