...
public class BinomialHeapExtractMin5Bug10Ix17Ix21Dx23Dx27I {
    ...
    public BinomialHeapExtractMin5Bug10Ix17Ix21Dx23Dx27I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        temp.child = temp.child; //mutGenLimit 1
        ...
        while (temp != null) { //mutGenLimit 0
            ...
            temp = temp.parent; //mutGenLimit 1
        }
