...
public class BinomialHeapExtractMin5Bug7Dx8Dx13Ix21Dx27D {
    ...
    public BinomialHeapExtractMin5Bug7Dx8Dx13Ix21Dx27D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = this.Nodes.parent.findMinNode(); //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
