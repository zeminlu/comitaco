...
public class BinomialHeapExtractMin4Bug10Dx13Dx15Ix17D {
    ...
    public BinomialHeapExtractMin4Bug10Dx13Dx15Ix17D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp.findMinNode().sibling; //mutGenLimit 1
        } else {
            this.extractMin().sibling = temp.sibling; //mutGenLimit 1
        }
