...
public class BinomialHeapExtractMin5Bug5Dx10Dx13Ix27Ix38D {
    ...
    public BinomialHeapExtractMin5Bug5Dx10Dx13Ix27Ix38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        icse.binomialheap.BinomialHeapNode temp = Nodes; //mutGenLimit 0
        icse.binomialheap.BinomialHeapNode prevTemp = this.Nodes; //mutGenLimit 1
        ...
        while (temp.key != minNode.key) { //mutGenLimit 0
            prevTemp = temp; //mutGenLimit 0
            temp = temp.findMinNode(); //mutGenLimit 1
        }
        if (prevTemp == null) { //mutGenLimit 0
        ...
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                temp = fakeNode.reverse( null ); //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
        ...
        return minNode.child; //mutGenLimit 1
    }
