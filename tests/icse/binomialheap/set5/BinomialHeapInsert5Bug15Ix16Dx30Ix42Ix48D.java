...
public class BinomialHeapInsert5Bug15Ix16Dx30Ix42Ix48D {
    ...
    public BinomialHeapInsert5Bug15Ix16Dx30Ix42Ix48D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        temp1 = tmp.child.sibling; //mutGenLimit 1
                    } else {
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            temp1.parent = temp2; //mutGenLimit 1
                            temp2 = temp2.sibling; //mutGenLimit 0
                            temp1.sibling = tmp; //mutGenLimit 0
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = this.extractMin().sibling; //mutGenLimit 1
