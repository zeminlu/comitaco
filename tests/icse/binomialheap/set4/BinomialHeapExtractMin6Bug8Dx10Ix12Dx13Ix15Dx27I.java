...
public class BinomialHeapExtractMin6Bug8Dx10Ix12Dx13Ix15Dx27I {
    ...
    public BinomialHeapExtractMin6Bug8Dx10Ix12Dx13Ix15Dx27I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (null == null) { //mutGenLimit 1
            this.Nodes.parent = temp.sibling; //mutGenLimit 1
        } else {
            prevTemp.sibling = temp.child.sibling; //mutGenLimit 1
        }
        ...
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                this.Nodes = fakeNode.reverse( null ); //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
