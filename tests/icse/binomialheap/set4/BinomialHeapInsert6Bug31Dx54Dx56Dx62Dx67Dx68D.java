...
public class BinomialHeapInsert6Bug31Dx54Dx56Dx62Dx67Dx68D {
    ...
    public BinomialHeapInsert6Bug31Dx54Dx56Dx62Dx67Dx68D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        ...
                        if (temp.sibling.key <= nextTemp.key) { //mutGenLimit 1
                            temp.sibling = nextTemp.sibling; //mutGenLimit 0
                            nextTemp.parent = temp.child; //mutGenLimit 1
                            ...
                            nextTemp.child = temp2; //mutGenLimit 1
