...
public class BinomialHeapExtractMin6Bug9Dx17Ix19Dx20Dx23Dx27D {
    ...
    public BinomialHeapExtractMin6Bug9Dx17Ix19Dx20Dx23Dx27D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp.key != minNode.key) { //mutGenLimit 0
            prevTemp = temp.parent; //mutGenLimit 1
        ...
        if (Nodes == this.extractMin() && fakeNode == null) { //mutGenLimit 1
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                Nodes = fakeNode.reverse( null ).sibling; //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
