...
public class BinomialHeapInsert3Bug12Dx14Ix42I {
    ...
    public BinomialHeapInsert3Bug12Dx14Ix42I() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        icse.binomialheap.BinomialHeapNode tmp = this.Nodes; //mutGenLimit 1
                        temp2 = temp2.sibling; //mutGenLimit 0
                        tmp.sibling.sibling = temp1.sibling; //mutGenLimit 1
                ...
                if (temp1 == null) { //mutGenLimit 0
                    ...
                    while (temp1.sibling != null) { //mutGenLimit 0
                        temp1.parent = temp1.sibling; //mutGenLimit 1
                    }
