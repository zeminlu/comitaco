...
public class BinomialHeapExtractMin4Bug20Ix23Dx26Dx27D {
    ...
    public BinomialHeapExtractMin4Bug20Ix23Dx26Dx27D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        while (temp != null) { //mutGenLimit 0
            this.extractMin().parent = null; //mutGenLimit 1
            temp = temp.sibling; //mutGenLimit 0
        }
        if (Nodes == fakeNode && fakeNode == null) { //mutGenLimit 1
            size = 0; //mutGenLimit 0
        } else {
            if (Nodes == temp && fakeNode != null) { //mutGenLimit 1
                Nodes = fakeNode.findMinNode(); //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
