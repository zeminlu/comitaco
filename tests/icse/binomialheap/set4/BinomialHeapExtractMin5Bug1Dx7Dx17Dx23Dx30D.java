...
public class BinomialHeapExtractMin5Bug1Dx7Dx17Dx23Dx30D {
    ...
    public BinomialHeapExtractMin5Bug1Dx7Dx17Dx23Dx30D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        temp = minNode.child; //mutGenLimit 1
        ...
        if (Nodes == null && fakeNode != null) { //mutGenLimit 1
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                ...
                if (Nodes != minNode && fakeNode == null) { //mutGenLimit 1
                    size--; //mutGenLimit 0
                } else {
