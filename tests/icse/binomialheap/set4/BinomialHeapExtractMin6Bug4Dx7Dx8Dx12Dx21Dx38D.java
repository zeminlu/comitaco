...
public class BinomialHeapExtractMin6Bug4Dx7Dx8Dx12Dx21Dx38D {
    ...
    public BinomialHeapExtractMin6Bug4Dx7Dx8Dx12Dx21Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = this.Nodes.findMinNode().sibling; //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        ...
        return minNode.sibling; //mutGenLimit 1
    }
