...
public class BinomialHeapInsert6Bug3Dx19Dx48Dx50Dx55Ix73D {
    ...
    public BinomialHeapInsert6Bug3Dx19Dx48Dx50Dx55Ix73D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp2.sibling == null || temp1.sibling.degree > temp2.degree) { //mutGenLimit 1
                                icse.binomialheap.BinomialHeapNode tmp = temp2; //mutGenLimit 0
                                temp2 = temp2.sibling; //mutGenLimit 0
                                tmp.sibling = temp1.sibling; //mutGenLimit 0
                                temp1.sibling = tmp; //mutGenLimit 0
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = this.Nodes.findMinNode().sibling; //mutGenLimit 1
                //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.key == temp.degree) { //mutGenLimit 1
                        prevTemp = temp; //mutGenLimit 0
                        temp = nextTemp; //mutGenLimit 0
                    } else {
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            temp.parent.sibling = nextTemp.sibling; //mutGenLimit 1
                    ...
                    nextTemp = this.extractMin().sibling; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
