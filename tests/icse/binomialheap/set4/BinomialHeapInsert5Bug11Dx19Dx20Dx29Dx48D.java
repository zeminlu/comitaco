...
public class BinomialHeapInsert5Bug11Dx19Dx20Dx29Dx48D {
    ...
    public BinomialHeapInsert5Bug11Dx19Dx20Dx29Dx48D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (++temp1.degree == temp2.degree) { //mutGenLimit 1
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree > temp2.parent.degree) { //mutGenLimit 1
                            ...
                            icse.binomialheap.BinomialHeapNode tmp = temp1.parent; //mutGenLimit 1
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = Nodes.findMinNode(); //mutGenLimit 1
