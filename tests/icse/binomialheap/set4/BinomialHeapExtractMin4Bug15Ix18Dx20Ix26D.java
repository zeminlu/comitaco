...
public class BinomialHeapExtractMin4Bug15Ix18Dx20Ix26D {
    ...
    public BinomialHeapExtractMin4Bug15Ix18Dx20Ix26D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == null) { //mutGenLimit 0
            ...
            prevTemp.parent.sibling = temp.sibling; //mutGenLimit 1
        }
        temp = temp.child; //mutGenLimit 0
        icse.binomialheap.BinomialHeapNode fakeNode = minNode; //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
