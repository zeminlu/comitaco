...
public class BinomialHeapInsert5Bug3Ix26Dx50Dx54Dx69D {
    ...
    public BinomialHeapInsert5Bug3Ix26Dx50Dx54Dx69D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            insertTemp.parent.key = value; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != --nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key++ <= nextTemp.key) { //mutGenLimit 1
                            ...
                            insertTemp.degree++; //mutGenLimit 1
                            temp = nextTemp; //mutGenLimit 0
                        }
                    }
