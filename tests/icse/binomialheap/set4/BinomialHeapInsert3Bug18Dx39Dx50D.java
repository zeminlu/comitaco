...
public class BinomialHeapInsert3Bug18Dx39Dx50D {
    ...
    public BinomialHeapInsert3Bug18Dx39Dx50D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.key) { //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.findMinNode().degree == temp.degree) { //mutGenLimit 1
