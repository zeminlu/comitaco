...
public class BinomialHeapFindMinimum5Bug1Dx2Dx3Dx4Dx7D {
    ...
    public BinomialHeapFindMinimum5Bug1Dx2Dx3Dx4Dx7D() {
    }
    ...
    public int findMinimum() {
        icse.binomialheap.BinomialHeapNode x = this.Nodes; //mutGenLimit 1
