...
public class BinomialHeapExtractMin4Bug7Ix8Dx30Dx38D {
    ...
    public BinomialHeapExtractMin4Bug7Ix8Dx30Dx38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode.sibling = Nodes.findMinNode(); //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp.child.key != minNode.key) { //mutGenLimit 1
            prevTemp = temp; //mutGenLimit 0
        ...
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                ...
                if (Nodes != null && true) { //mutGenLimit 1
                    size--; //mutGenLimit 0
                } else {
