...
public class BinomialHeapInsert4Bug29Dx42Ix50Dx58D {
    ...
    public BinomialHeapInsert4Bug29Dx42Ix50Dx58D() {
    }
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            icse.binomialheap.BinomialHeapNode tmp = temp1.findMinNode(); //mutGenLimit 1
