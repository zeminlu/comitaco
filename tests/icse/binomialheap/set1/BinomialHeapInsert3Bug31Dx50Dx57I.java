...
public class BinomialHeapInsert3Bug31Dx50Dx57I {
    ...
    public BinomialHeapInsert3Bug31Dx50Dx57I() {
    }
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            temp2 = temp2.sibling.parent; //mutGenLimit 1
                            temp1.sibling = tmp; //mutGenLimit 0
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != ++nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            nextTemp.sibling.sibling = temp.child; //mutGenLimit 1
