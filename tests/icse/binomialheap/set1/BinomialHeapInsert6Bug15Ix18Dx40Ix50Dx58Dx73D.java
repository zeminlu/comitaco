...
public class BinomialHeapInsert6Bug15Ix18Dx40Ix50Dx58Dx73D {
    ...
    public BinomialHeapInsert6Bug15Ix18Dx40Ix50Dx58Dx73D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.child.degree) { //mutGenLimit 1
                ...
                if (temp1 == null) { //mutGenLimit 0
                    this.Nodes = Nodes; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.sibling.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            temp.child = temp2; //mutGenLimit 1
                    ...
                    nextTemp = temp.sibling.sibling; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
