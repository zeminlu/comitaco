...
public class BinomialHeapInsert5Bug5Dx19Dx22Dx23Dx32D {
    ...
    public BinomialHeapInsert5Bug5Dx19Dx22Dx23Dx32D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (false || temp1.sibling.degree > temp2.degree) { //mutGenLimit 1
                                icse.binomialheap.BinomialHeapNode tmp = temp2; //mutGenLimit 0
                                temp2 = temp2.sibling; //mutGenLimit 0
                                tmp.sibling = this.Nodes.sibling; //mutGenLimit 1
                                temp1.sibling = this.Nodes; //mutGenLimit 1
                                temp1 = tmp.sibling; //mutGenLimit 0
                            } else {
