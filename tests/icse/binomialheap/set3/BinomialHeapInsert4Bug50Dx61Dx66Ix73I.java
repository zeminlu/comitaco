...
public class BinomialHeapInsert4Bug50Dx61Dx66Ix73I {
    ...
    public BinomialHeapInsert4Bug50Dx61Dx66Ix73I() {
    }
        ...
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp1.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            temp.child.parent = nextTemp; //mutGenLimit 1
                    ...
                    nextTemp.child = temp.sibling; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
