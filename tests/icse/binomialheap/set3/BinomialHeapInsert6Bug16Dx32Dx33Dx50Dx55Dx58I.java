...
public class BinomialHeapInsert6Bug16Dx32Dx33Dx50Dx55Dx58I {
    ...
    public BinomialHeapInsert6Bug16Dx32Dx33Dx50Dx55Dx58I() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        temp1 = tmp.findMinNode().sibling; //mutGenLimit 1
                    } else {
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            ...
                            temp2 = temp2.sibling; //mutGenLimit 0
                            temp1.sibling = tmp.child; //mutGenLimit 1
                            if (tmp == this.Nodes.findMinNode()) { //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != temp1 && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        prevTemp = temp; //mutGenLimit 0
                        temp = nextTemp; //mutGenLimit 0
                    } else {
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            temp.sibling = nextTemp; //mutGenLimit 1
                            nextTemp.parent = temp; //mutGenLimit 0
                            nextTemp.sibling = temp.child; //mutGenLimit 0
                            temp1.child = nextTemp; //mutGenLimit 1
