...
public class BinomialHeapInsert4Bug3Ix34Ix56Ix66D {
    ...
    public BinomialHeapInsert4Bug3Ix34Ix56Ix66D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            this.Nodes.key = value; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            this.extractMin().parent = temp; //mutGenLimit 1
                            ...
                            temp.parent = this.Nodes; //mutGenLimit 1
