...
public class BinomialHeapInsert4Bug18Dx46Dx51Ix54D {
    ...
    public BinomialHeapInsert4Bug18Dx46Dx51Ix54D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                icse.binomialheap.BinomialHeapNode prevTemp = this.extractMin(); //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        temp2 = temp; //mutGenLimit 1
                        temp = nextTemp; //mutGenLimit 0
                    } else {
                        if (temp.child.key <= nextTemp.key) { //mutGenLimit 1
