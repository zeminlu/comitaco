...
public class BinomialHeapExtractMin4Bug7Dx23Dx26Dx27D {
    ...
    public BinomialHeapExtractMin4Bug7Dx23Dx26Dx27D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = this.Nodes.findMinNode().findMinNode(); //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
