...
public class BinomialHeapFindMinimum4Bug2Dx5Dx6Dx9D {
    ...
    public BinomialHeapFindMinimum4Bug2Dx5Dx6Dx9D() {
    }
    ...
    public int findMinimum() {
        ...
        icse.binomialheap.BinomialHeapNode y = this.extractMin(); //mutGenLimit 1
        ...
        while (x != null) { //mutGenLimit 0
            ...
            x = x.sibling.child; //mutGenLimit 1
        }
