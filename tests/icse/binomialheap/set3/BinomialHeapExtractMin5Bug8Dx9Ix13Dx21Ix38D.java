...
public class BinomialHeapExtractMin5Bug8Dx9Ix13Dx21Ix38D {
    ...
    public BinomialHeapExtractMin5Bug8Dx9Ix13Dx21Ix38D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (this.extractMin().key != minNode.key) { //mutGenLimit 1
            minNode = temp; //mutGenLimit 1
            temp = temp.sibling; //mutGenLimit 0
        }
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp.parent; //mutGenLimit 1
        } else {
        ...
        while (temp != null) { //mutGenLimit 0
            ...
            temp.child = temp.sibling; //mutGenLimit 1
        }
