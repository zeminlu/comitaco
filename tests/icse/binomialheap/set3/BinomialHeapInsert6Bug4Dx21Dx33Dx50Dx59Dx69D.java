...
public class BinomialHeapInsert6Bug4Dx21Dx33Dx50Dx59Dx69D {
    ...
    public BinomialHeapInsert6Bug4Dx21Dx33Dx50Dx59Dx69D() {
    }
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (!(temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree)) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            this.Nodes.degree++; //mutGenLimit 1
                        } else {
                            ...
                            nextTemp.parent.degree++; //mutGenLimit 1
                            temp = nextTemp; //mutGenLimit 0
                        }
                    }
