...
public class BinomialHeapExtractMin6Bug8Dx10Ix13Dx18Dx20Ix30D {
    ...
    public BinomialHeapExtractMin6Bug8Dx10Ix13Dx18Dx20Ix30D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == null) { //mutGenLimit 0
            Nodes = temp.parent.sibling; //mutGenLimit 1
        } else {
            prevTemp.sibling = temp.sibling; //mutGenLimit 0
        }
        temp = temp.child; //mutGenLimit 0
        icse.binomialheap.BinomialHeapNode fakeNode = this.Nodes; //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
