...
public class BinomialHeapExtractMin6Bug17Dx18Dx19Dx21Ix23Dx27I {
    ...
    public BinomialHeapExtractMin6Bug17Dx18Dx19Dx21Ix23Dx27I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        icse.binomialheap.BinomialHeapNode fakeNode = temp.findMinNode(); //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp != fakeNode) { //mutGenLimit 1
            temp.parent = null; //mutGenLimit 0
            fakeNode = temp.sibling; //mutGenLimit 1
        }
        if (Nodes == null && fakeNode == this.extractMin()) { //mutGenLimit 1
            size = 0; //mutGenLimit 0
        } else {
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                prevTemp = fakeNode.reverse( null ); //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
