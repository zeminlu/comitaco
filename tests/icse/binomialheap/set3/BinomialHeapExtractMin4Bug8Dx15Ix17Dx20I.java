...
public class BinomialHeapExtractMin4Bug8Dx15Ix17Dx20I {
    ...
    public BinomialHeapExtractMin4Bug8Dx15Ix17Dx20I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        while (temp.key != minNode.findMinNode().key) { //mutGenLimit 1
            prevTemp = temp; //mutGenLimit 0
