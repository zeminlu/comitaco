...
public class BinomialHeapInsert6Bug26Ix42Ix48Dx49Dx50Dx54D {
    ...
    public BinomialHeapInsert6Bug26Ix42Ix48Dx49Dx50Dx54D() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree > temp2.degree) { //mutGenLimit 0
                                ...
                                this.Nodes = temp1.sibling; //mutGenLimit 1
                            }
                        } else {
                ...
                if (temp1 == null) { //mutGenLimit 0
                    ...
                    while (temp1.sibling != null) { //mutGenLimit 0
                        insertTemp = temp1.sibling; //mutGenLimit 1
                    }
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = this.Nodes.child.sibling; //mutGenLimit 1
                //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
                while (nextTemp != nextTemp) { //mutGenLimit 1
                    if (temp.degree != this.Nodes.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= this.Nodes.key) { //mutGenLimit 1
