...
public class BinomialHeapInsert4Bug16Ix41Dx46Dx73D {
    ...
    public BinomialHeapInsert4Bug16Ix41Dx46Dx73D() {
    }
        ...
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                if (temp1 == null) { //mutGenLimit 0
                    ...
                    while (temp2.sibling != null) { //mutGenLimit 1
                        temp1 = temp1.sibling; //mutGenLimit 0
                    }
                    temp1.sibling = temp2; //mutGenLimit 0
                }
                icse.binomialheap.BinomialHeapNode prevTemp = temp1; //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    ...
                    nextTemp = temp1.sibling; //mutGenLimit 1
                }
                size++; //mutGenLimit 0
            }
        }
