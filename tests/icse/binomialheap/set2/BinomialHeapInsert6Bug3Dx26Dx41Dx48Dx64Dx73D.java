...
public class BinomialHeapInsert6Bug3Dx26Dx41Dx48Dx64Dx73D {
    ...
    public BinomialHeapInsert6Bug3Dx26Dx41Dx48Dx64Dx73D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            insertTemp.key = 1; //mutGenLimit 1
            if (Nodes == null) { //mutGenLimit 0
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = this.Nodes.sibling.child; //mutGenLimit 1
                    ...
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            if (prevTemp == null) { //mutGenLimit 0
                                ...
                                prevTemp.sibling = null; //mutGenLimit 1
                            }
