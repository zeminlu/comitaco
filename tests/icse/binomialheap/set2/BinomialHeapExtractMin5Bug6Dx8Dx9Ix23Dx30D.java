...
public class BinomialHeapExtractMin5Bug6Dx8Dx9Ix23Dx30D {
    ...
    public BinomialHeapExtractMin5Bug6Dx8Dx9Ix23Dx30D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        icse.binomialheap.BinomialHeapNode temp = Nodes; //mutGenLimit 0
        icse.binomialheap.BinomialHeapNode prevTemp = null; //mutGenLimit 0
        icse.binomialheap.BinomialHeapNode minNode = this.extractMin(); //mutGenLimit 1
        ...
        if (Nodes == fakeNode && fakeNode == null) { //mutGenLimit 1
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                ...
                if (Nodes != prevTemp && fakeNode == null) { //mutGenLimit 1
                    size--; //mutGenLimit 0
                } else {
