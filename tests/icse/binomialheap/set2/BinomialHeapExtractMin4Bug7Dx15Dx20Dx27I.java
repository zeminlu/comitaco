...
public class BinomialHeapExtractMin4Bug7Dx15Dx20Dx27I {
    ...
    public BinomialHeapExtractMin4Bug7Dx15Dx20Dx27I() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        minNode = this.extractMin().findMinNode(); //mutGenLimit 1
        //@ decreasing \reach(temp, BinomialHeapNode, sibling).int_size();
        ...
        if (prevTemp == null) { //mutGenLimit 0
            ...
            prevTemp.sibling = prevTemp.sibling; //mutGenLimit 1
        }
        ...
        if (Nodes == null && fakeNode == null) { //mutGenLimit 0
            ...
            if (Nodes == null && fakeNode != null) { //mutGenLimit 0
                this.Nodes.sibling = fakeNode.reverse( null ); //mutGenLimit 1
                size--; //mutGenLimit 0
            } else {
                if (Nodes != null && fakeNode == null) { //mutGenLimit 0
                    size--; //mutGenLimit 0
