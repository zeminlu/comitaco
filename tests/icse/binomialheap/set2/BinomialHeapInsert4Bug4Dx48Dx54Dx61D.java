...
public class BinomialHeapInsert4Bug4Dx48Dx54Dx61D {
    ...
    public BinomialHeapInsert4Bug4Dx48Dx54Dx61D() {
    }
    ...
    public void insert( int value ) {
        if (value > 0) { //mutGenLimit 0
            ...
            if (Nodes == this.Nodes) { //mutGenLimit 1
                ...
                icse.binomialheap.BinomialHeapNode nextTemp = this.Nodes.sibling.findMinNode(); //mutGenLimit 1
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != nextTemp.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 0
                        ...
                        if (nextTemp.key <= nextTemp.key) { //mutGenLimit 1
