...
public class BinomialHeapExtractMin5Bug13Ix15Dx21Ix23Dx26D {
    ...
    public BinomialHeapExtractMin5Bug13Ix15Dx21Ix23Dx26D() {
    }
    ...
    public /* @ nullable @ */icse.binomialheap.BinomialHeapNode extractMin() {
        ...
        if (prevTemp == null) { //mutGenLimit 0
            ...
            prevTemp.sibling = minNode.sibling; //mutGenLimit 1
        }
        ...
        if (true && fakeNode == null) { //mutGenLimit 1
