...
public class BinomialHeapInsert3Bug19Dx23Ix70D {
    ...
    public BinomialHeapInsert3Bug19Dx23Ix70D() {
    }
                    ...
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp2.degree) { //mutGenLimit 0
                            if (temp1.sibling == null || temp1.sibling.degree <= temp2.degree) { //mutGenLimit 1
                                ...
                                temp2 = temp2.sibling; //mutGenLimit 0
                                tmp.sibling = temp1.sibling; //mutGenLimit 0
                                this.Nodes.sibling = tmp; //mutGenLimit 1
                                temp1 = tmp.sibling; //mutGenLimit 0
                            } else {
