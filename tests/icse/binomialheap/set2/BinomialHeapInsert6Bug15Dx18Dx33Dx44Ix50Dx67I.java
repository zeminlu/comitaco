...
public class BinomialHeapInsert6Bug15Dx18Dx33Dx44Ix50Dx67I {
    ...
    public BinomialHeapInsert6Bug15Dx18Dx33Dx44Ix50Dx67I() {
    }
            ...
            if (Nodes == null) { //mutGenLimit 0
                ...
                while (temp1 != null && temp2 != null) { //mutGenLimit 0
                    if (temp1.degree == temp2.degree) { //mutGenLimit 0
                        ...
                        if (temp1.degree < temp1.degree) { //mutGenLimit 1
                ...
                if (temp1 == null) { //mutGenLimit 0
                    ...
                    temp1.sibling.child = temp2; //mutGenLimit 1
                }
                ...
                while (nextTemp != null) { //mutGenLimit 0
                    if (temp.degree != temp1.degree || nextTemp.sibling != null && nextTemp.sibling.degree == temp.degree) { //mutGenLimit 1
                        ...
                        if (temp.key <= nextTemp.key) { //mutGenLimit 0
                            ...
                            temp1.sibling = nextTemp.child; //mutGenLimit 1
