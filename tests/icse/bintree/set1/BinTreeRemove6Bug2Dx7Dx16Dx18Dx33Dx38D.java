...
public class BinTreeRemove6Bug2Dx7Dx16Dx18Dx33Dx38D {
    ...
    public BinTreeRemove6Bug2Dx7Dx16Dx18Dx33Dx38D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        while (node != null && true) { //mutGenLimit 1
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                ...
                if (true) { //mutGenLimit 1
                    while (predecessor.right != null) { //mutGenLimit 0
                        predecessor = predecessor.parent.right; //mutGenLimit 1
                    }
                }
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (pullUp != pullUp) { //mutGenLimit 1
