...
public class BinTreeRemove5Bug14Dx26Dx27Dx38Ix45I {
    ...
    public BinTreeRemove5Bug14Dx26Dx27Dx38Ix45I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != this.root) { //mutGenLimit 1
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (node.parent.left == node) { //mutGenLimit 0
                ...
                if (pullUp != null) { //mutGenLimit 0
                    pullUp.left.parent = node.parent; //mutGenLimit 1
                }
            }
        }
        size--; //mutGenLimit 0
