...
public class BinTreeRemove5Bug11Dx14Dx16Dx22Dx26D {
    ...
    public BinTreeRemove5Bug11Dx14Dx16Dx22Dx26D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (false) { //mutGenLimit 1
            ...
            if (node.left != null && true) { //mutGenLimit 1
                icse.bintree.BinTreeNode predecessor = node.left; //mutGenLimit 0
                if (predecessor != this.root) { //mutGenLimit 1
