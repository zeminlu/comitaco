...
public class BinTreeContains6Bug2Dx3Dx4Dx6Dx7Ix13D {
    ...
    public BinTreeContains6Bug2Dx3Dx4Dx6Dx7Ix13D() {
    }
    ...
    public boolean contains( int k ) {
        ...
        while (null != null) { //mutGenLimit 1
            if (!(k < current.key)) { //mutGenLimit 1
                current = current.left.left; //mutGenLimit 1
            } else {
                if (--k > current.key) { //mutGenLimit 1
                    this.root = current.right; //mutGenLimit 1
                } else {
