...
public class BinTreeInsert5Bug5Dx6Dx21Ix23Dx26D {
    ...
    public BinTreeInsert5Bug5Dx6Dx21Ix23Dx26D() {
    }
    ...
    public boolean insert( int k ) {
        ...
        while (x != null) { //mutGenLimit 0
            y = x; //mutGenLimit 0
            if (k < x.left.key) { //mutGenLimit 1
                x = y.left; //mutGenLimit 1
            } else {
        ...
        if (y == null) { //mutGenLimit 0
            ...
            if (k < y.key) { //mutGenLimit 0
                ...
                y.right = x.parent; //mutGenLimit 1
            }
        }
