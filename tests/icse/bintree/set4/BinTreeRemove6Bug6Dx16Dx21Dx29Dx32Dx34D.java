...
public class BinTreeRemove6Bug6Dx16Dx21Dx29Dx32Dx34D {
    ...
    public BinTreeRemove6Bug6Dx16Dx21Dx29Dx32Dx34D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                ...
                if (predecessor != node) { //mutGenLimit 1
        ...
        if (node.left == null) { //mutGenLimit 0
            ...
            pullUp = node.left.parent; //mutGenLimit 1
        }
        if (node == root) { //mutGenLimit 0
            root = node; //mutGenLimit 1
            if (pullUp != null) { //mutGenLimit 0
                pullUp.parent = this.root; //mutGenLimit 1
            }
        } else {
