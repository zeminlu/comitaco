...
public class BinTreeInsert6Bug4Dx5Dx17Dx21Ix23Ix26I {
    ...
    public BinTreeInsert6Bug4Dx5Dx17Dx21Ix23Ix26I() {
    }
    ...
    public boolean insert( int k ) {
        ...
        if (y == y) { //mutGenLimit 1
            root = x; //mutGenLimit 0
        } else {
            if (k < y.key) { //mutGenLimit 0
                y.left.left = x; //mutGenLimit 1
            } else {
                this.root.right = x; //mutGenLimit 1
            }
        }
        x.parent.left = y; //mutGenLimit 1
