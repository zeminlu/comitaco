...
public class BinTreeRemove6Bug2Dx14Dx31Dx32Dx33Dx40I {
    ...
    public BinTreeRemove6Bug2Dx14Dx31Dx32Dx33Dx40I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        while (node != this.root && node.key != element) { //mutGenLimit 1
        ...
        if (!(node == root)) { //mutGenLimit 1
            ...
            if (node.parent.left == node) { //mutGenLimit 0
                ...
                if (pullUp != null) { //mutGenLimit 0
                    pullUp.right = node.parent; //mutGenLimit 1
                }
            } else {
