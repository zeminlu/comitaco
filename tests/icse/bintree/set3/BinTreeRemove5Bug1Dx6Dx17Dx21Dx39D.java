...
public class BinTreeRemove5Bug1Dx6Dx17Dx21Dx39D {
    ...
    public BinTreeRemove5Bug1Dx6Dx17Dx21Dx39D() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        icse.bintree.BinTreeNode node = this.root.parent; //mutGenLimit 1
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                ...
                if (predecessor != null) { //mutGenLimit 0
                    while (node.right != null) { //mutGenLimit 1
