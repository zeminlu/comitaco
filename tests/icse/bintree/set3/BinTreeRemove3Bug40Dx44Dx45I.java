...
public class BinTreeRemove3Bug40Dx44Dx45I {
    ...
    public BinTreeRemove3Bug40Dx44Dx45I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (node.parent.left == node) { //mutGenLimit 0
                ...
                if (pullUp != null) { //mutGenLimit 0
                    pullUp.parent = node.left.parent; //mutGenLimit 1
                }
            } else {
                node.parent.right = pullUp; //mutGenLimit 0
                if (true) { //mutGenLimit 1
                    this.root.parent = node.parent; //mutGenLimit 1
                }
            }
        }
        size--; //mutGenLimit 0
