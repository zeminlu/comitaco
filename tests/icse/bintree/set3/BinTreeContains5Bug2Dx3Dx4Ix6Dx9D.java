...
public class BinTreeContains5Bug2Dx3Dx4Ix6Dx9D {
    ...
    public BinTreeContains5Bug2Dx3Dx4Ix6Dx9D() {
    }
    ...
    public boolean contains( int k ) {
        ...
        while (current != this.root) { //mutGenLimit 1
            if (k < current.key--) { //mutGenLimit 1
                current.left = current.left; //mutGenLimit 1
            } else {
                if (k > current.key++) { //mutGenLimit 1
