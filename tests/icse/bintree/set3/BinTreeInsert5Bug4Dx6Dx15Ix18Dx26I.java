...
public class BinTreeInsert5Bug4Dx6Dx15Ix18Dx26I {
    ...
    public BinTreeInsert5Bug4Dx6Dx15Ix18Dx26I() {
    }
    ...
    public boolean insert( int k ) {
        ...
        x.left = new icse.bintree.BinTreeNode(); //mutGenLimit 1
