...
public class BinTreeRemove5Bug2Dx6Dx21Ix27Dx38I {
    ...
    public BinTreeRemove5Bug2Dx6Dx21Ix27Dx38I() {
    }
    ...
    public boolean remove( int element ) { //mutGenLimit 0
        ...
        while (node != null && node.right.key != element) { //mutGenLimit 1
        ...
        if (node == null) { //mutGenLimit 0
            ...
            if (node.left != null && node.right != null) { //mutGenLimit 0
                ...
                node.left.key = predecessor.key; //mutGenLimit 1
        ...
        if (node == root) { //mutGenLimit 0
            ...
            if (node.parent.left == node) { //mutGenLimit 0
                node.parent = pullUp; //mutGenLimit 1
                if (pullUp != null) { //mutGenLimit 0
