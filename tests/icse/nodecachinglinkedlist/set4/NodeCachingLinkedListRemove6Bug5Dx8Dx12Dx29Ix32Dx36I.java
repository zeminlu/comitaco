...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx8Dx12Dx29Ix32Dx36I {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx8Dx12Dx29Ix32Dx36I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index > this.modCount) { //mutGenLimit 1
        ...
        node.next.next = node.previous; //mutGenLimit 1
