...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug1Dx21Dx30Dx38D {
    ...
    public NodeCachingLinkedListRemove4Bug1Dx21Dx30Dx38D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (currentIndex > this.maximumCacheSize) { //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.firstCachedNode = null; //mutGenLimit 1
