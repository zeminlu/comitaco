...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug2Dx11Dx14Dx31Dx35Dx37D {
    ...
    public NodeCachingLinkedListRemove6Bug2Dx11Dx14Dx31Dx35Dx37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        this.modCount = this.modCount + this.size; //mutGenLimit 1
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.value = this.size; //mutGenLimit 1
