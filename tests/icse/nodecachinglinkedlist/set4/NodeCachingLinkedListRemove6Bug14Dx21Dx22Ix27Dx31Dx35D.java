...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug14Dx21Dx22Ix27Dx31Dx35D {
    ...
    public NodeCachingLinkedListRemove6Bug14Dx21Dx22Ix27Dx31Dx35D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (2 > index) { //mutGenLimit 1
                this.firstCachedNode = node.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
