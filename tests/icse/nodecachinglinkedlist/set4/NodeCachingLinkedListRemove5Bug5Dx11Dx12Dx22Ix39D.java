...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug5Dx11Dx12Dx22Ix39D {
    ...
    public NodeCachingLinkedListRemove5Bug5Dx11Dx12Dx22Ix39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size * 2) { //mutGenLimit 1
            ...
            while (currentIndex > index) { //mutGenLimit 0
                node.value = node.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.cacheSize = this.cacheSize + this.DEFAULT_MAXIMUM_CACHE_SIZE; //mutGenLimit 1
        }
