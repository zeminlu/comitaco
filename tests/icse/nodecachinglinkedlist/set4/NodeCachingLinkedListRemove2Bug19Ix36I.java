...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove2Bug19Ix36I {
    ...
    public NodeCachingLinkedListRemove2Bug19Ix36I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            node.value = this.header; //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.next.next = nextCachedNode; //mutGenLimit 1
