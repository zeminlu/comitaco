...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug11Dx28Ix29Dx30D {
    ...
    public NodeCachingLinkedListRemove4Bug11Dx28Ix29Dx30D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (0 < this.size / 2) { //mutGenLimit 1
        ...
        this.firstCachedNode.previous.next = node.next; //mutGenLimit 1
        node.next.previous = node; //mutGenLimit 1
        this.size = this.size - this.modCount; //mutGenLimit 1
