...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx8Dx11Dx12Dx13Dx30D {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx8Dx11Dx12Dx13Dx30D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize == this.size) { //mutGenLimit 1
            throw new java.lang.RuntimeException();
        }
        ...
        if (index == this.size / 2) { //mutGenLimit 1
            node = this.header.next.previous; //mutGenLimit 1
