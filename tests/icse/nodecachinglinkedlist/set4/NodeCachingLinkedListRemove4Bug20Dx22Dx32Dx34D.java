...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug20Dx22Dx32Dx34D {
    ...
    public NodeCachingLinkedListRemove4Bug20Dx22Dx32Dx34D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (--this.cacheSize < this.maximumCacheSize) { //mutGenLimit 1
            ...
            nextCachedNode = firstCachedNode; //mutGenLimit 1
