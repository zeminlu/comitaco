...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug2Dx3Dx5Dx7Dx10D {
    ...
    public NodeCachingLinkedListContains5Bug2Dx3Dx5Dx7Dx10D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node.next != header && node.value != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
            this.maximumCacheSize++; //mutGenLimit 1
        }
        if (node != this.header.next && node.value == arg) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
