...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug11Dx16Dx28Ix32Dx37D {
    ...
    public NodeCachingLinkedListRemove5Bug11Dx16Dx28Ix32Dx37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.next.previous.next = node.next; //mutGenLimit 1
