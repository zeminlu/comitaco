...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug19Ix28Dx37D {
    ...
    public NodeCachingLinkedListRemove3Bug19Ix28Dx37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.value = new java.lang.Integer( this.modCount ); //mutGenLimit 1
