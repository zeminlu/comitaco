...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst2Bug2Dx8D {
    ...
    public NodeCachingLinkedListAddFirst2Bug2Dx8D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = this.DEFAULT_MAXIMUM_CACHE_SIZE; //mutGenLimit 1
