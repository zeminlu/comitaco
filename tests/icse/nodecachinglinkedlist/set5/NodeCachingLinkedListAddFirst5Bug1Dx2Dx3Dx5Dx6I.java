...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst5Bug1Dx2Dx3Dx5Dx6I {
    ...
    public NodeCachingLinkedListAddFirst5Bug1Dx2Dx3Dx5Dx6I() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        icse.nodecachinglinkedlist.LinkedListNode newNode = this.header; //mutGenLimit 1
        newNode.value = new java.lang.Integer( 1 ); //mutGenLimit 1
        ...
        newNode.previous = insertBeforeNode.previous.previous; //mutGenLimit 1
        insertBeforeNode.previous.next.next.previous = newNode; //mutGenLimit 1
