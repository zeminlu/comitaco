...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Ix3Dx5Ix6Dx7Dx9D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Ix3Dx5Ix6Dx7Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        insertBeforeNode.previous.next.previous = newNode.next; //mutGenLimit 1
