...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug8Dx30Dx31Dx39I {
    ...
    public NodeCachingLinkedListRemove4Bug8Dx30Dx31Dx39I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        this.size = this.DEFAULT_MAXIMUM_CACHE_SIZE - 1; //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.DEFAULT_MAXIMUM_CACHE_SIZE = this.cacheSize + 1; //mutGenLimit 1
        }
