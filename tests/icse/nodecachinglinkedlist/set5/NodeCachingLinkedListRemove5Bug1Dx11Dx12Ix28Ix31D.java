...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug1Dx11Dx12Ix28Ix31D {
    ...
    public NodeCachingLinkedListRemove5Bug1Dx11Dx12Ix28Ix31D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        icse.nodecachinglinkedlist.LinkedListNode node = this.firstCachedNode; //mutGenLimit 1
        ...
        if (index < this.size / this.maximumCacheSize) { //mutGenLimit 1
            node.previous = this.header.next; //mutGenLimit 1
        ...
        node.previous.next.next = node.next; //mutGenLimit 1
        node.next.previous = node.previous; //mutGenLimit 0
        this.size = this.size - 1; //mutGenLimit 0
        this.modCount = this.modCount + 2; //mutGenLimit 1
