...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug1Dx3Dx5Dx8Dx10D {
    ...
    public NodeCachingLinkedListContains5Bug1Dx3Dx5Dx8Dx10D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        icse.nodecachinglinkedlist.LinkedListNode node = this.header.previous.next; //mutGenLimit 1
        int counter = 0; //mutGenLimit 0
        //@decreasing size - counter;
        while (node != this.header.previous && node.value != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
