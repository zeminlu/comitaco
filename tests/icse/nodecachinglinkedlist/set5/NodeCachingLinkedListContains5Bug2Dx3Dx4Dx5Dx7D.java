...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug2Dx3Dx4Dx5Dx7D {
    ...
    public NodeCachingLinkedListContains5Bug2Dx3Dx4Dx5Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        if (node != header && node.value == this.firstCachedNode) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
