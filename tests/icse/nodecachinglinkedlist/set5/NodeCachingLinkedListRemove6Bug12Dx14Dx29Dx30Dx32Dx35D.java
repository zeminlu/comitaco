...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug12Dx14Dx29Dx30Dx32Dx35D {
    ...
    public NodeCachingLinkedListRemove6Bug12Dx14Dx29Dx30Dx32Dx35D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.next.previous = this.firstCachedNode.previous; //mutGenLimit 1
        ...
        if (this.cacheSize < ++this.maximumCacheSize) { //mutGenLimit 1
            ...
            node.previous = this.header; //mutGenLimit 1
