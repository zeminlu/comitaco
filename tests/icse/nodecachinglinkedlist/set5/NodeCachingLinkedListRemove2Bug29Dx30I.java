...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove2Bug29Dx30I {
    ...
    public NodeCachingLinkedListRemove2Bug29Dx30I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.next.previous = node.next.previous; //mutGenLimit 1
        this.maximumCacheSize = this.size - 1; //mutGenLimit 1
