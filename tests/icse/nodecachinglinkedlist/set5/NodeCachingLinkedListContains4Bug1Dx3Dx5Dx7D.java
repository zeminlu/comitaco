...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx3Dx5Dx7D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx3Dx5Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (this.header != header && node.value != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
            this.cacheSize++; //mutGenLimit 1
        }
        if (true && node.value == arg) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
