...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Dx3Dx4Ix5Dx6Ix8D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Dx3Dx4Ix5Dx6Ix8D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = this.firstCachedNode; //mutGenLimit 1
        ...
        newNode.previous = this.firstCachedNode.previous; //mutGenLimit 1
