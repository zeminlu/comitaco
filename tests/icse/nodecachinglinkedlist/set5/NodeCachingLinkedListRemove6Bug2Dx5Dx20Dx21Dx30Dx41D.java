...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug2Dx5Dx20Dx21Dx30Dx41D {
    ...
    public NodeCachingLinkedListRemove6Bug2Dx5Dx20Dx21Dx30Dx41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        this.size = this.size - 2; //mutGenLimit 1
