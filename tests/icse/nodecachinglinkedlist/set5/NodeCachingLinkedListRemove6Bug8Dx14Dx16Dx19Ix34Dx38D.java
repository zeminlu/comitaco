...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug8Dx14Dx16Dx19Ix34Dx38D {
    ...
    public NodeCachingLinkedListRemove6Bug8Dx14Dx16Dx19Ix34Dx38D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index > this.maximumCacheSize) { //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            nextCachedNode = this.firstCachedNode.previous; //mutGenLimit 1
