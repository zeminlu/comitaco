...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug5Dx14Dx31Dx36I {
    ...
    public NodeCachingLinkedListRemove4Bug5Dx14Dx31Dx36I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (this.DEFAULT_MAXIMUM_CACHE_SIZE < index) { //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.firstCachedNode.next = nextCachedNode; //mutGenLimit 1
