...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx12Dx13Dx14Dx32Dx37D {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx12Dx13Dx14Dx32Dx37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.size == this.size) { //mutGenLimit 1
            throw new java.lang.RuntimeException();
        }
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            node = this.header.previous.next; //mutGenLimit 1
            int currentIndex = index; //mutGenLimit 1
        ...
        if (this.cacheSize >= this.maximumCacheSize) { //mutGenLimit 1
            ...
            node.value = oldValue; //mutGenLimit 1
