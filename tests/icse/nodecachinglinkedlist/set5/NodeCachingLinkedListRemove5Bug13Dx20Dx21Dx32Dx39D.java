...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug13Dx20Dx21Dx32Dx39D {
    ...
    public NodeCachingLinkedListRemove5Bug13Dx20Dx21Dx32Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize--) { //mutGenLimit 1
            ...
            this.cacheSize = this.size + 1; //mutGenLimit 1
        }
