...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains3Bug1Dx2Dx7D {
    ...
    public NodeCachingLinkedListContains3Bug1Dx2Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        if (node != header && node.value == new Integer(this.modCount)) { //mutGenLimit 1
            return true; //mutGenLimit 0
        }
