...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst5Bug3Dx4Dx5Ix6Dx9D {
    ...
    public NodeCachingLinkedListAddFirst5Bug3Dx4Dx5Ix6Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.previous.next = insertBeforeNode.previous; //mutGenLimit 1
        insertBeforeNode.previous.next.previous = null; //mutGenLimit 1
