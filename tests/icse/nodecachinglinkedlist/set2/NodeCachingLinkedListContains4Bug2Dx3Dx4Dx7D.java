...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug2Dx3Dx4Dx7D {
    ...
    public NodeCachingLinkedListContains4Bug2Dx3Dx4Dx7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new Integer(1)) { //mutGenLimit 1
