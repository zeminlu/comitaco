...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug8Dx11Dx19Ix31Dx37Dx39D {
    ...
    public NodeCachingLinkedListRemove6Bug8Dx11Dx19Ix31Dx37Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / this.maximumCacheSize) { //mutGenLimit 1
            ...
            this.firstCachedNode = this.header; //mutGenLimit 1
        ...
        this.modCount = modCount + 1; //mutGenLimit 1
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.value = this.firstCachedNode; //mutGenLimit 1
            this.firstCachedNode = node; //mutGenLimit 0
            this.cacheSize = this.cacheSize + this.size; //mutGenLimit 1
        }
