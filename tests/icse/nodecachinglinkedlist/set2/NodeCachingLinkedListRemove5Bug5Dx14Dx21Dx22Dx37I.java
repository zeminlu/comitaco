...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug5Dx14Dx21Dx22Dx37I {
    ...
    public NodeCachingLinkedListRemove5Bug5Dx14Dx21Dx22Dx37I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            nextCachedNode.value = null; //mutGenLimit 1
