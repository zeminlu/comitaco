...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Dx4Ix5Dx6Dx8Dx9D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Dx4Ix5Dx6Dx8Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = this.cacheSize; //mutGenLimit 1
        ...
        newNode.previous = this.header.previous; //mutGenLimit 1
        insertBeforeNode.previous.next.previous = this.header; //mutGenLimit 1
