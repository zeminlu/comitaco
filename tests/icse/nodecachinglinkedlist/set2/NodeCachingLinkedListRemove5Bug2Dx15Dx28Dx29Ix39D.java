...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug2Dx15Dx28Dx29Ix39D {
    ...
    public NodeCachingLinkedListRemove5Bug2Dx15Dx28Dx29Ix39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.previous.next = this.header.next; //mutGenLimit 1
        node.next.previous.next = node.previous; //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.cacheSize = this.cacheSize + this.maximumCacheSize; //mutGenLimit 1
        }
