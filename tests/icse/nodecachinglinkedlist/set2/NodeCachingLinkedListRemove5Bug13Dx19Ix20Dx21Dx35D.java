...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug13Dx19Ix20Dx21Dx35D {
    ...
    public NodeCachingLinkedListRemove5Bug13Dx19Ix20Dx21Dx35D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            node.next = this.header; //mutGenLimit 1
