...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug2Dx28Ix30Ix37D {
    ...
    public NodeCachingLinkedListRemove4Bug2Dx28Ix30Ix37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.maximumCacheSize < 0) { //mutGenLimit 1
        ...
        node.previous.next.previous = node.next; //mutGenLimit 1
        node.next.previous = node.previous; //mutGenLimit 0
        this.modCount = this.size - 1; //mutGenLimit 1
