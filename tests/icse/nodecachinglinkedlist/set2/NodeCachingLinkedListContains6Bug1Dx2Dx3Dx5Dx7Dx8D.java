...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains6Bug1Dx2Dx3Dx5Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains6Bug1Dx2Dx3Dx5Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.previous != arg) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
