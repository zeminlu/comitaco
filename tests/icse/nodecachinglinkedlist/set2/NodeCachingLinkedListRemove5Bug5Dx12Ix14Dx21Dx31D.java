...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug5Dx12Ix14Dx21Dx31D {
    ...
    public NodeCachingLinkedListRemove5Bug5Dx12Ix14Dx21Dx31D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.modCount == this.size) { //mutGenLimit 1
            throw new java.lang.RuntimeException();
        }
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            this.header = this.header.next; //mutGenLimit 1
            ...
            while (currentIndex > 0) { //mutGenLimit 1
