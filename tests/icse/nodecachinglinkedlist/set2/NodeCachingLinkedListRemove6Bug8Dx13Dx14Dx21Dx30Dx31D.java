...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug8Dx13Dx14Dx21Dx30Dx31D {
    ...
    public NodeCachingLinkedListRemove6Bug8Dx13Dx14Dx21Dx30Dx31D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            int currentIndex = this.DEFAULT_MAXIMUM_CACHE_SIZE; //mutGenLimit 1
            ...
            while (currentIndex > this.cacheSize) { //mutGenLimit 1
        ...
        this.size = this.size - this.size; //mutGenLimit 1
