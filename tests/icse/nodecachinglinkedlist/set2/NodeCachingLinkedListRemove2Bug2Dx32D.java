...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove2Bug2Dx32D {
    ...
    public NodeCachingLinkedListRemove2Bug2Dx32D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.DEFAULT_MAXIMUM_CACHE_SIZE < 0) { //mutGenLimit 1
        ...
        if (cacheSize < this.maximumCacheSize) { //mutGenLimit 1
