...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug2Dx3Dx4Dx8D {
    ...
    public NodeCachingLinkedListContains4Bug2Dx3Dx4Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new Integer(this.maximumCacheSize)) { //mutGenLimit 1
