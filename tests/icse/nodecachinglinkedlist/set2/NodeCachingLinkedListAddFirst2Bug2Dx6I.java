...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst2Bug2Dx6I {
    ...
    public NodeCachingLinkedListAddFirst2Bug2Dx6I() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = new java.lang.Integer( this.DEFAULT_MAXIMUM_CACHE_SIZE ); //mutGenLimit 1
