...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug5Dx11Dx22Dx28D {
    ...
    public NodeCachingLinkedListRemove4Bug5Dx11Dx22Dx28D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.maximumCacheSize / 2) { //mutGenLimit 1
