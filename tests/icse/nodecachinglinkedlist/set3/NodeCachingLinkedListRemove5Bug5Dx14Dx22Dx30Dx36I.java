...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug5Dx14Dx22Dx30Dx36I {
    ...
    public NodeCachingLinkedListRemove5Bug5Dx14Dx22Dx30Dx36I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.previous.next = nextCachedNode; //mutGenLimit 1
