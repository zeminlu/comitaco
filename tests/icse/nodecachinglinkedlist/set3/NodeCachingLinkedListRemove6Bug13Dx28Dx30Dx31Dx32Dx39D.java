...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug13Dx28Dx30Dx31Dx32Dx39D {
    ...
    public NodeCachingLinkedListRemove6Bug13Dx28Dx30Dx31Dx32Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            int currentIndex = this.cacheSize; //mutGenLimit 1
        ...
        this.size = this.size - this.cacheSize; //mutGenLimit 1
