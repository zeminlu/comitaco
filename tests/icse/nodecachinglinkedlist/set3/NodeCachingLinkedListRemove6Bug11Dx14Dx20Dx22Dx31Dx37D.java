...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug11Dx14Dx20Dx22Dx31Dx37D {
    ...
    public NodeCachingLinkedListRemove6Bug11Dx14Dx20Dx22Dx31Dx37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / this.modCount) { //mutGenLimit 1
