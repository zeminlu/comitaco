...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug15Ix29Ix35Ix37D {
    ...
    public NodeCachingLinkedListRemove4Bug15Ix29Ix35Ix37D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.previous.previous = null; //mutGenLimit 1
            node.next = nextCachedNode; //mutGenLimit 0
            node.value = true; //mutGenLimit 1
