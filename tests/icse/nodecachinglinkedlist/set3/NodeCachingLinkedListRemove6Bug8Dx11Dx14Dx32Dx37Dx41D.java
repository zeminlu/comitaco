...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug8Dx11Dx14Dx32Dx37Dx41D {
    ...
    public NodeCachingLinkedListRemove6Bug8Dx11Dx14Dx32Dx37Dx41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (!(index < this.size / 2)) { //mutGenLimit 1
            ...
            while (this.cacheSize < index) { //mutGenLimit 1
        ...
        if (this.cacheSize < this.modCount) { //mutGenLimit 1
        ...
        return new java.lang.Integer( index ); //mutGenLimit 1
    }
