...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug5Dx11Dx14Dx27Dx32D {
    ...
    public NodeCachingLinkedListRemove5Bug5Dx11Dx14Dx27Dx32D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.maximumCacheSize == this.size) { //mutGenLimit 1
            throw new java.lang.RuntimeException();
        }
        if (index > this.size) { //mutGenLimit 0
            throw new java.lang.IndexOutOfBoundsException();
        }
        if (this.cacheSize < this.size / 2) { //mutGenLimit 1
        ...
        oldValue = node.next.value; //mutGenLimit 1
        ...
        if (this.cacheSize < maximumCacheSize) { //mutGenLimit 1
