...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Ix4Ix5Dx6Ix8Dx10D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Ix4Ix5Dx6Ix8Dx10D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.previous.value = o; //mutGenLimit 1
        icse.nodecachinglinkedlist.LinkedListNode insertBeforeNode = this.header.next; //mutGenLimit 0
        newNode.next.value = insertBeforeNode; //mutGenLimit 1
        newNode.previous = insertBeforeNode.next; //mutGenLimit 1
        insertBeforeNode.previous.previous = newNode; //mutGenLimit 1
