...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Ix3Dx4Dx5Ix6Ix7I {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Ix3Dx4Dx5Ix6Ix7I() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.next = newNode; //mutGenLimit 1
        insertBeforeNode.previous = insertBeforeNode.previous; //mutGenLimit 1
        insertBeforeNode.previous.next.next = newNode; //mutGenLimit 1
