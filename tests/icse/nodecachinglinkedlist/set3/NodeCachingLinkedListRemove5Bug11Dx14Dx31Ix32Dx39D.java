...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug11Dx14Dx31Ix32Dx39D {
    ...
    public NodeCachingLinkedListRemove5Bug11Dx14Dx31Ix32Dx39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (--this.cacheSize < this.maximumCacheSize) { //mutGenLimit 1
            ...
            this.cacheSize = cacheSize + 1; //mutGenLimit 1
        }
