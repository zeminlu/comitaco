...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug2Dx3Dx7Dx10D {
    ...
    public NodeCachingLinkedListContains4Bug2Dx3Dx7Dx10D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new java.lang.Integer( this.modCount )) { //mutGenLimit 1
            node = node.next; //mutGenLimit 0
