...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains6Bug1Dx3Dx4Dx5Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains6Bug1Dx3Dx4Dx5Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != this.header) { //mutGenLimit 1
            node = node; //mutGenLimit 1
            this.size++; //mutGenLimit 1
        }
        if (node != header && node.next.value == arg) { //mutGenLimit 1
