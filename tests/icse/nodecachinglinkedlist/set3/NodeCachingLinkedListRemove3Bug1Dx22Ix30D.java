...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug1Dx22Ix30D {
    ...
    public NodeCachingLinkedListRemove3Bug1Dx22Ix30D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        icse.nodecachinglinkedlist.LinkedListNode node = this.header; //mutGenLimit 1
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            while (currentIndex > index) { //mutGenLimit 0
                node.previous = node.previous; //mutGenLimit 1
                currentIndex--; //mutGenLimit 0
            }
        }
