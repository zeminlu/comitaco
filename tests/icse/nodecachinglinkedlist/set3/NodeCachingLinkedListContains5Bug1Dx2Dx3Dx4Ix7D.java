...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug1Dx2Dx3Dx4Ix7D {
    ...
    public NodeCachingLinkedListContains5Bug1Dx2Dx3Dx4Ix7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new java.lang.Integer( this.maximumCacheSize )) { //mutGenLimit 1
