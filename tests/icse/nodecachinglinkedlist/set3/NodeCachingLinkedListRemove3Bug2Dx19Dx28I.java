...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove3Bug2Dx19Dx28I {
    ...
    public NodeCachingLinkedListRemove3Bug2Dx19Dx28I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            node = this.firstCachedNode; //mutGenLimit 1
        ...
        node.previous.previous.next = node.next; //mutGenLimit 1
