...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Dx3Dx6Ix7Ix8Dx9D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Dx3Dx6Ix7Ix8Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = true; //mutGenLimit 1
        ...
        insertBeforeNode.previous.next.value = newNode; //mutGenLimit 1
