...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst4Bug4Ix5Dx6Ix9D {
    ...
    public NodeCachingLinkedListAddFirst4Bug4Ix5Dx6Ix9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        insertBeforeNode.previous.next.previous.value = newNode; //mutGenLimit 1
        insertBeforeNode.previous = newNode; //mutGenLimit 0
        this.size++; //mutGenLimit 0
        modCount++; //mutGenLimit 1
