...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug1Dx3Dx4Dx5Ix6Ix7I {
    ...
    public NodeCachingLinkedListAddFirst6Bug1Dx3Dx4Dx5Ix6Ix7I() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        this.header.previous.next.previous = newNode; //mutGenLimit 1
        this.firstCachedNode.previous = newNode; //mutGenLimit 1
