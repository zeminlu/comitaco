...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst6Bug2Dx4Ix5Ix6Ix7Ix9D {
    ...
    public NodeCachingLinkedListAddFirst6Bug2Dx4Ix5Ix6Ix7Ix9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.next.next = insertBeforeNode; //mutGenLimit 1
        this.firstCachedNode.previous = insertBeforeNode.previous; //mutGenLimit 1
        this.firstCachedNode.previous.next.previous = newNode; //mutGenLimit 1
