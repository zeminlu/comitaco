...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains6Bug2Dx3Dx4Ix5Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains6Bug2Dx3Dx4Ix5Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new Integer(this.cacheSize)) { //mutGenLimit 1
            node.value = node.next; //mutGenLimit 1
            this.cacheSize++; //mutGenLimit 1
        }
        if (node != header && node.value == new Boolean(false)) { //mutGenLimit 1
