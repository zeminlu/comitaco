...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx13Dx28Dx31Dx39Ix41D {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx13Dx28Dx31Dx39Ix41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        node.previous.next = node.next.next; //mutGenLimit 1
