...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug2Dx11Dx28Dx29Ix30Dx35D {
    ...
    public NodeCachingLinkedListRemove6Bug2Dx11Dx28Dx29Ix30Dx35D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.previous = this.firstCachedNode; //mutGenLimit 1
