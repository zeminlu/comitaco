...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug1Dx3Dx4Dx8D {
    ...
    public NodeCachingLinkedListContains4Bug1Dx3Dx4Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.next.value != arg) { //mutGenLimit 1
