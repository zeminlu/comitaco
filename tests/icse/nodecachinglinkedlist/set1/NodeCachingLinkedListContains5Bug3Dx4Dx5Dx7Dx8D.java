...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains5Bug3Dx4Dx5Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains5Bug3Dx4Dx5Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && this.header.value != arg) { //mutGenLimit 1
