...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst4Bug2Dx5Ix7Ix8D {
    ...
    public NodeCachingLinkedListAddFirst4Bug2Dx5Ix7Ix8D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        newNode.value = this.maximumCacheSize; //mutGenLimit 1
        ...
        newNode.previous.value = insertBeforeNode.previous; //mutGenLimit 1
