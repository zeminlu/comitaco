...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug12Ix13Dx28Ix31Dx36D {
    ...
    public NodeCachingLinkedListRemove5Bug12Ix13Dx28Ix31Dx36D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            node.next = this.header.next; //mutGenLimit 1
