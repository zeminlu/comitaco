...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains4Bug2Dx3Dx4Ix7D {
    ...
    public NodeCachingLinkedListContains4Bug2Dx3Dx4Ix7D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        while (node != header && node.value != new Integer(this.modCount)) { //mutGenLimit 1
