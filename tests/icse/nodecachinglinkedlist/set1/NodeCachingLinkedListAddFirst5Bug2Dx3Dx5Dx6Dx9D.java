...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListAddFirst5Bug2Dx3Dx5Dx6Dx9D {
    ...
    public NodeCachingLinkedListAddFirst5Bug2Dx3Dx5Dx6Dx9D() {
    ...
    public boolean addFirst( java.lang.Object o ) {
        ...
        icse.nodecachinglinkedlist.LinkedListNode insertBeforeNode = this.header.next.next; //mutGenLimit 1
        newNode.next = insertBeforeNode; //mutGenLimit 0
        newNode.previous = insertBeforeNode.next; //mutGenLimit 1
        insertBeforeNode.previous.next.previous = insertBeforeNode; //mutGenLimit 1
