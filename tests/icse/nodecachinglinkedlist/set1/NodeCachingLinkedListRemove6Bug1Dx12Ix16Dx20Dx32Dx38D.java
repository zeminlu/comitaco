...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug1Dx12Ix16Dx20Dx32Dx38D {
    ...
    public NodeCachingLinkedListRemove6Bug1Dx12Ix16Dx20Dx32Dx38D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index < this.size / 2) { //mutGenLimit 0
            ...
            int currentIndex = size; //mutGenLimit 1
        ...
        if (this.cacheSize < --this.maximumCacheSize) { //mutGenLimit 1
            ...
            this.firstCachedNode = nextCachedNode; //mutGenLimit 1
