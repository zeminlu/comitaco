...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug8Dx11Dx21Dx36D {
    ...
    public NodeCachingLinkedListRemove4Bug8Dx11Dx21Dx36D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.next = nextCachedNode.next; //mutGenLimit 1
