...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove6Bug5Dx8Dx14Dx28Dx37Dx38D {
    ...
    public NodeCachingLinkedListRemove6Bug5Dx8Dx14Dx28Dx37Dx38D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (index == this.cacheSize) { //mutGenLimit 1
            throw new java.lang.RuntimeException();
        }
        if (index > this.DEFAULT_MAXIMUM_CACHE_SIZE) { //mutGenLimit 1
        ...
        node.previous.next = node.next.previous; //mutGenLimit 1
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.value = 1; //mutGenLimit 1
            this.firstCachedNode = this.firstCachedNode; //mutGenLimit 1
