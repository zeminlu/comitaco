...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove4Bug5Dx11Dx35Ix39D {
    ...
    public NodeCachingLinkedListRemove4Bug5Dx11Dx35Ix39D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            this.firstCachedNode.previous = null; //mutGenLimit 1
