...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove2Bug11Dx39I {
    ...
    public NodeCachingLinkedListRemove2Bug11Dx39I() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.DEFAULT_MAXIMUM_CACHE_SIZE < this.size / 2) { //mutGenLimit 1
