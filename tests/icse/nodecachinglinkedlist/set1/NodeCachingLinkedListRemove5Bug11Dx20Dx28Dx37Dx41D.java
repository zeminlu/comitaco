...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListRemove5Bug11Dx20Dx28Dx37Dx41D {
    ...
    public NodeCachingLinkedListRemove5Bug11Dx20Dx28Dx37Dx41D() {
    ...
    public /*@nullable@*/java.lang.Object remove( final int index ) {
        ...
        if (this.cacheSize < this.maximumCacheSize) { //mutGenLimit 0
            ...
            node.value = this.DEFAULT_MAXIMUM_CACHE_SIZE; //mutGenLimit 1
