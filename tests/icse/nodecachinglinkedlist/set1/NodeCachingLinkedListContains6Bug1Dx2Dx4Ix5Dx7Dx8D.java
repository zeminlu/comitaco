...
* @j2daType
*//*@ nullable_by_default @*/
public class NodeCachingLinkedListContains6Bug1Dx2Dx4Ix5Dx7Dx8D {
    ...
    public NodeCachingLinkedListContains6Bug1Dx2Dx4Ix5Dx7Dx8D() {
    ...
    public /*@ pure @*/boolean contains( /*@ nullable @*/java.lang.Object arg ) {
        ...
        if (node.previous != header && node.value == arg) { //mutGenLimit 1
