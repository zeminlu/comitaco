...
*
*/
public class SinglyLinkedListContains6Bug5Dx7Dx10Dx20Dx21Ix23D {
    ...
    public SinglyLinkedListContains6Bug5Dx7Dx10Dx20Dx21Ix23D() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (result != false && current != null) { //mutGenLimit 1
            boolean equalVal;
            if (null == null && current.value == null) { //mutGenLimit 1
                equalVal = true; //mutGenLimit 0
            } else {
                if (valueParam != valueParam) { //mutGenLimit 1
