...
*
*/
public class SinglyLinkedListInsertBack5Bug2Dx3Ix8Dx9Dx10D {
    ...
    public SinglyLinkedListInsertBack5Bug2Dx3Ix8Dx9Dx10D() {
    }
    ...
    public void insertBack( java.lang.Object arg ) {
        ...
        if (this.header == null) { //mutGenLimit 0
            ...
            //@decreasing \reach(current, SinglyLinkedListNode, next).int_size();
            while (current.next != current) { //mutGenLimit 1
