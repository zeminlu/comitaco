...
*
*/
public class SinglyLinkedListContains6Bug4Dx5Dx7Dx10Dx11Dx12I {
    ...
    public SinglyLinkedListContains6Bug4Dx5Dx7Dx10Dx11Dx12I() {
    }
    ...
    public boolean contains( /*@nullable@*/java.lang.Object valueParam ) {
        ...
        while (result == false && current != this.header) { //mutGenLimit 1
            boolean equalVal;
            if (valueParam == valueParam && current.value == null) { //mutGenLimit 1
