...
*
*/
public class SinglyLinkedListGetNode6Bug1Dx4Dx5Dx6Ix9Dx11D {
    ...
    public SinglyLinkedListGetNode6Bug1Dx4Dx5Dx6Ix9Dx11D() {
    }
    ...
    public icse.singlylinkedlist.SinglyLinkedListNode getNode( int index ) {
        ...
        //@decreasing \reach(current, SinglyLinkedListNode, next).int_size();
        while (result == null && false) { //mutGenLimit 1
            if (index == index) { //mutGenLimit 1
