            ...
            if ( result == false && current != null ) {
                ...
                if (
                    ...
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 0\nequalVal=false; //mutGenLimit 1 //lineNumber=53\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_1=true; //lineNumber=81\n");
				} catch (IOException ioexception) {
				}
				roops_goal_1 = true;
            }
            if ( result == false && current != null ) {
                ...
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=85\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_13=true; //lineNumber=92\n");
					} catch (IOException ioexception) {
					}
					roops_goal_13 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_14=true; //lineNumber=94\n");
						} catch (IOException ioexception) {
						}
						roops_goal_14 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_16=true; //lineNumber=96\n");
							} catch (IOException ioexception) {
							}
							roops_goal_16 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_17=true; //lineNumber=99\n");
							} catch (IOException ioexception) {
							}
							roops_goal_17 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_15=true; //lineNumber=103\n");
						} catch (IOException ioexception) {
						}
						roops_goal_15 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_18=true; //lineNumber=108\n");
					} catch (IOException ioexception) {
					}
					roops_goal_18 = true;
                    try {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_11=true; //lineNumber=117\n");
				} catch (IOException ioexception) {
				}
				roops_goal_11 = true;
            }
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_20=true; //lineNumber=120\n");
				} catch (IOException ioexception) {
				}
				roops_goal_20 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=121\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_22=true; //lineNumber=124\n");
					} catch (IOException ioexception) {
					}
					roops_goal_22 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 2\nequalVal=false; //mutGenLimit 1 //lineNumber=125\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_23=true; //lineNumber=128\n");
					} catch (IOException ioexception) {
					}
					roops_goal_23 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_24=true; //lineNumber=130\n");
						} catch (IOException ioexception) {
						}
						roops_goal_24 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_26=true; //lineNumber=132\n");
							} catch (IOException ioexception) {
							}
							roops_goal_26 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_27=true; //lineNumber=135\n");
							} catch (IOException ioexception) {
							}
							roops_goal_27 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_25=true; //lineNumber=139\n");
						} catch (IOException ioexception) {
						}
						roops_goal_25 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_28=true; //lineNumber=144\n");
					} catch (IOException ioexception) {
					}
					roops_goal_28 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_29=true; //lineNumber=147\n");
					} catch (IOException ioexception) {
					}
					roops_goal_29 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=150\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_30=true; //lineNumber=156\n");
				} catch (IOException ioexception) {
				}
				roops_goal_30 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=157\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_32=true; //lineNumber=160\n");
					} catch (IOException ioexception) {
					}
					roops_goal_32 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 3\nequalVal=false; //mutGenLimit 1 //lineNumber=161\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_33=true; //lineNumber=164\n");
					} catch (IOException ioexception) {
					}
					roops_goal_33 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_34=true; //lineNumber=166\n");
						} catch (IOException ioexception) {
						}
						roops_goal_34 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_36=true; //lineNumber=168\n");
							} catch (IOException ioexception) {
							}
							roops_goal_36 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_37=true; //lineNumber=171\n");
							} catch (IOException ioexception) {
							}
							roops_goal_37 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_35=true; //lineNumber=175\n");
						} catch (IOException ioexception) {
						}
						roops_goal_35 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_38=true; //lineNumber=180\n");
					} catch (IOException ioexception) {
					}
					roops_goal_38 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_39=true; //lineNumber=183\n");
					} catch (IOException ioexception) {
					}
					roops_goal_39 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=186\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_40=true; //lineNumber=192\n");
				} catch (IOException ioexception) {
				}
				roops_goal_40 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=193\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_42=true; //lineNumber=196\n");
					} catch (IOException ioexception) {
					}
					roops_goal_42 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 4\nequalVal=false; //mutGenLimit 1 //lineNumber=197\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_43=true; //lineNumber=200\n");
					} catch (IOException ioexception) {
					}
					roops_goal_43 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_44=true; //lineNumber=202\n");
						} catch (IOException ioexception) {
						}
						roops_goal_44 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_46=true; //lineNumber=204\n");
							} catch (IOException ioexception) {
							}
							roops_goal_46 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_47=true; //lineNumber=207\n");
							} catch (IOException ioexception) {
							}
							roops_goal_47 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_45=true; //lineNumber=211\n");
						} catch (IOException ioexception) {
						}
						roops_goal_45 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_48=true; //lineNumber=216\n");
					} catch (IOException ioexception) {
					}
					roops_goal_48 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_49=true; //lineNumber=219\n");
					} catch (IOException ioexception) {
					}
					roops_goal_49 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=222\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_50=true; //lineNumber=228\n");
				} catch (IOException ioexception) {
				}
				roops_goal_50 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=229\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_52=true; //lineNumber=232\n");
					} catch (IOException ioexception) {
					}
					roops_goal_52 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 5\nequalVal=false; //mutGenLimit 1 //lineNumber=233\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_53=true; //lineNumber=236\n");
					} catch (IOException ioexception) {
					}
					roops_goal_53 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_54=true; //lineNumber=238\n");
						} catch (IOException ioexception) {
						}
						roops_goal_54 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_56=true; //lineNumber=240\n");
							} catch (IOException ioexception) {
							}
							roops_goal_56 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_57=true; //lineNumber=243\n");
							} catch (IOException ioexception) {
							}
							roops_goal_57 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_55=true; //lineNumber=247\n");
						} catch (IOException ioexception) {
						}
						roops_goal_55 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_58=true; //lineNumber=252\n");
					} catch (IOException ioexception) {
					}
					roops_goal_58 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_59=true; //lineNumber=255\n");
					} catch (IOException ioexception) {
					}
					roops_goal_59 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=258\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_60=true; //lineNumber=264\n");
				} catch (IOException ioexception) {
				}
				roops_goal_60 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=265\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_62=true; //lineNumber=268\n");
					} catch (IOException ioexception) {
					}
					roops_goal_62 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 6\nequalVal=false; //mutGenLimit 1 //lineNumber=269\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_63=true; //lineNumber=272\n");
					} catch (IOException ioexception) {
					}
					roops_goal_63 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_64=true; //lineNumber=274\n");
						} catch (IOException ioexception) {
						}
						roops_goal_64 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_66=true; //lineNumber=276\n");
							} catch (IOException ioexception) {
							}
							roops_goal_66 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_67=true; //lineNumber=279\n");
							} catch (IOException ioexception) {
							}
							roops_goal_67 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_65=true; //lineNumber=283\n");
						} catch (IOException ioexception) {
						}
						roops_goal_65 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_68=true; //lineNumber=288\n");
					} catch (IOException ioexception) {
					}
					roops_goal_68 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_69=true; //lineNumber=291\n");
					} catch (IOException ioexception) {
					}
					roops_goal_69 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=294\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_70=true; //lineNumber=300\n");
				} catch (IOException ioexception) {
				}
				roops_goal_70 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"boolean equalVal; //lineNumber=301\n");
				} catch (IOException ioexception) {
				}
				boolean equalVal;
                if (
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_72=true; //lineNumber=304\n");
					} catch (IOException ioexception) {
					}
					roops_goal_72 = true;
                    try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"//mutID 7\nequalVal=false; //mutGenLimit 1 //lineNumber=305\n");
					} catch (IOException ioexception) {
					}
					equalVal = false;
                } else {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_73=true; //lineNumber=308\n");
					} catch (IOException ioexception) {
					}
					roops_goal_73 = true;
                    if ( value_param != null ) {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_74=true; //lineNumber=310\n");
						} catch (IOException ioexception) {
						}
						roops_goal_74 = true;
                        if ( value_param == current.value ) {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_76=true; //lineNumber=312\n");
							} catch (IOException ioexception) {
							}
							roops_goal_76 = true;
                            try {
							...
							try {
								FileUtils
										.appendToFile(
												"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
												"roops_goal_77=true; //lineNumber=315\n");
							} catch (IOException ioexception) {
							}
							roops_goal_77 = true;
                            try {
						...
						try {
							FileUtils
									.appendToFile(
											"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
											"roops_goal_75=true; //lineNumber=319\n");
						} catch (IOException ioexception) {
						}
						roops_goal_75 = true;
                        try {
                ...
                if ( equalVal == true ) {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_78=true; //lineNumber=324\n");
					} catch (IOException ioexception) {
					}
					roops_goal_78 = true;
                    try {
					...
					try {
						FileUtils
								.appendToFile(
										"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
										"roops_goal_79=true; //lineNumber=327\n");
					} catch (IOException ioexception) {
					}
					roops_goal_79 = true;
                }
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"current=current.next; //lineNumber=330\n");
				} catch (IOException ioexception) {
				}
				current = current.next;
            } else {
            ...
            if ( result == false && current != null ) {
				...
				try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"roops_goal_80=true; //lineNumber=336\n");
				} catch (IOException ioexception) {
				}
				roops_goal_80 = true;
                try {
					FileUtils
							.appendToFile(
									"/Users/framundo/ITBA/comitaco/tests/roops/core/objects/sequential/SinglyLinkedList.java_contains",
									"terminatesInTime=true; //lineNumber=337\n");
				} catch (IOException ioexception) {
				}
