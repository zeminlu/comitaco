 ...
 *//*@ nullable_by_default @*/public class NodeCachingLinkedList {
    ...
    /*@
	  ...
	  @					n!=null && n.previous!=null && n.previous.next==n && n.next!=null &&
	  @					n.next.previous==n ) &&
	  @
...
//      @ ensures ( \forall LinkedListNode n; \reach(header, LinkedListNode, next).has(n) && n != ]; \old(\reach(header, LinkedListNode, next)).has(n) );
