...
public class BinTreeIsBST1Bug {
    ...
    private ase2016.bintree.BinTreeNode isBSTNode(ase2016.bintree.BinTreeNode node, ase2016.bintree.BinTreeNode prev) {
    	if (root != null) {
    		ase2016.bintree.BinTreeNode newPrev = isBSTNode(root.left, prev);
    		if (newPrev==null)
    			return null;
