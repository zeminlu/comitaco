...
/**
* BinomialHeapFindMinimum3Bugs2x5x7 is an implementation of binomial heaps with 3 bugs
* injected in lines 2 and 5 and 7 of method findMinimum. First bug replaces:
* y = Nodes;
* with
* y = null;
* Second bug replaces:
