...
public class JDynAlloyASTVisitor extends JmlAstTransverseStatementVisitor {
	...
	public void visitJmlMethodDeclaration(
		...
		String programId = programDeclaration.getSignatureId()+"_"+programDeclaration.getProgramId()+"_0";

//		if (programDeclaration.isPure() && !programDeclaration.getProgramId().equals(TacoConfigurator.getInstance().getMethodToCheck())){
//			//			JStatement programBody = new JSkip();
//			JProgramDeclaration pureProgramDeclaration = MethodDeclarationSolver.getPureMethodDeclaration(jmlMethodDeclaration, this.buffer, this.modulesObjectState,
//					this.modulesNoStaticFields, this.varsEncodingValueOfArithmeticOperationsInObjectInvariants, 
//					this.predsEncodingValueOfArithmeticOperationsInObjectInvariants, this.compilationUnits);
//
//			if (jmlMethodDeclaration.body() != null) {
//				PureBlockStatementsVisitor pureBlockScopeTranslator = new PureBlockStatementsVisitor();
//				pureBlockScopeTranslator.setVarsEncodingValueOfArithmeticOperationsInRequiresAndEnsures(pureProgramDeclaration.getVarsResultOfArithmeticOperationsInContracts());
//				pureBlockScopeTranslator.methodReturnValue = !(jmlMethodDeclaration.returnType() instanceof CVoidType);
//				if (pureBlockScopeTranslator.methodReturnValue){
//					jmlMethodDeclaration.body().accept(pureBlockScopeTranslator);
//
//					JStatement	programBody = pureBlockScopeTranslator.getJAlloyProgram();
//
//					JProgramDeclaration newPureProgramDeclaration = new JProgramDeclaration(
//							pureProgramDeclaration.isAbstract(), 
//							false,
//							pureProgramDeclaration.isPure(),
//							pureProgramDeclaration.getSignatureId(), 
//							pureProgramDeclaration.getProgramId(),
//							pureProgramDeclaration.getParameters(), 
//							pureProgramDeclaration.getSpecCases(), 
//							programBody,
//							pureProgramDeclaration.getVarsResultOfArithmeticOperationsInContracts(),
//							pureProgramDeclaration.getPredsEncodingValueOfArithmeticOperationsInContracts()
//							);
//
//					buffer.getPrograms().add(newPureProgramDeclaration);
//
//				} else {
//					throw new TacoException("Program " + programId + " is pure and should not have void return type.");
//				}
//			} else {
//				throw new TacoException("Program " + programId + " is pure but its code is missing.");
//			}
//		} 
		...
		if (jmlMethodDeclaration.body() != null) {
			BlockStatementsVisitor blockScopeTranslator = new BlockStatementsVisitor();
			blockScopeTranslator.setVarsEncodingValueOfArithmeticOperationsInRequiresAndEnsures(programDeclaration.getVarsResultOfArithmeticOperationsInContracts());
