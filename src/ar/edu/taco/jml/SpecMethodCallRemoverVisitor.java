...
public class SpecMethodCallRemoverVisitor extends JmlAstClonerStatementVisitor {
	...
	public void visitJmlConstructorDeclaration(JmlConstructorDeclaration self) {
		String fullyQualifiedConstructorName = this.getClassName() + self.ident() + "_0";
		if (fullyQualifiedConstructorName.equals(TacoConfigurator.getInstance().getMethodToCheck())){
...
//					JMethodCallExpression newMethodCall = new JMethodCallExpression(methodCall.getTokenReference(), methodCall.prefix(), methodCall.ident(), newArgsForMethodCall, false);
	...
	public void visitJmlMethodDeclaration(JmlMethodDeclaration self) {
		String fullyQualifiedMethodName = this.getClassName() + self.ident() + "_0";
		if (fullyQualifiedMethodName.equals(TacoConfigurator.getInstance().getMethodToCheck())){
			ArrayList<JStatement> newBody = new ArrayList<JStatement>();
			newBody.add(self.body());
...
//					newMethodCall.setType(methodCall.getApparentType());
	...
	public void visitJmlGenericSpecBody(JmlGenericSpecBody self) {
		...
		JmlGenericSpecBody newSelf = new JmlGenericSpecBody(newClauses);
		this.getStack().push(newSelf);
	}
	...
	public void visitEqualityExpression(JEqualityExpression self) {
		...
		JEqualityExpression newSelf = new JEqualityExpression(self.getTokenReference(), self.oper(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitAddExpression(JAddExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JAddExpression newSelf = new JAddExpression(self.getTokenReference(), newLeft, newRight);
	...
	public void visitBitwiseExpression(JBitwiseExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JBitwiseExpression newSelf = new JBitwiseExpression(self.getTokenReference(), self.oper(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitCastExpression(JCastExpression self) {
		...
		JCastExpression newSelf = new JCastExpression(self.getTokenReference(), theExpre, self.getApparentType());
		this.getStack().push(newSelf);
	}
	...
	public void visitDivideExpression(JDivideExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JDivideExpression newSelf = new JDivideExpression(self.getTokenReference(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitMinusExpression(JMinusExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JMinusExpression newSelf = new JMinusExpression(self.getTokenReference(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitModuloExpression(JModuloExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JModuloExpression newSelf = new JModuloExpression(self.getTokenReference(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitMultExpression(JMultExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JMultExpression newSelf = new JMultExpression(self.getTokenReference(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitJmlRelationalExpression(JmlRelationalExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JmlRelationalExpression newSelf = new JmlRelationalExpression(self.getTokenReference(), self.oper(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitRelationalExpression(JRelationalExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JRelationalExpression newSelf = new JRelationalExpression(self.getTokenReference(), self.oper(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitShiftExpression(JShiftExpression self) {
		...
		self.right().accept(this);
		JExpression newRight = (JExpression)this.getStack().pop();
		JShiftExpression newSelf = new JShiftExpression(self.getTokenReference(), self.oper(), newLeft, newRight);
		this.getStack().push(newSelf);
	}
	...
	public void visitUnaryExpression(JUnaryExpression self) {
		...
		theExpre.accept(this);
		JExpression theNewExpre = (JExpression)this.getStack().pop();
		JUnaryExpression newSelf = new JUnaryExpression(self.getTokenReference(), self.oper(), theNewExpre);
		this.getStack().push(newSelf);
	}
